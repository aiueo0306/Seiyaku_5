...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://medical.nihon-generic.co.jp/news/"
GAKKAI = "日本ジェネリック（医療従事者）"
...
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.c_link-archive01 li"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "/"
month_unit = "/"
...
POPUP_BUTTONS = ["薬局薬剤師"] if POPUP_MODE else [] 
