...
# ===== 固定情報（学会サイト） =====
url = "https://www.alcon.com/jp-JP/newsroom/press-releases-2025/#"
current_year = datetime.datetime.now().year

BASE_URL = re.sub(r"\d{4}", str(current_year), url, count=1)
GAKKAI = "アルコン"

SELECTOR_TITLE = "div.coh-container.coh-container-boxed div.coh-wysiwyg"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.coh-container.coh-container-boxed div.coh-wysiwyg"  # typo修正済み
date_selector = "p"
date_index = 0
year_unit = "年 "
month_unit = "月 "
...
POPUP_BUTTONS = ["Accept All Cookies","はい"] if POPUP_MODE else [] 
...
with sync_playwright() as p:
    ...
    try:
        print("▶ ページにアクセス中...")
        page.goto(BASE_URL, timeout=2400000)
