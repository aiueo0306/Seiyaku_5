...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://mink.nipponkayaku.co.jp/product/index.php?action_product_news=true"
GAKKAI = "日本化薬(医療従事者)"
...
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul#newsList li"  # typo修正済み
date_selector = "span.newsList_date"
date_index = 0
year_unit = "."
month_unit = "."
day_unit = ""
...
POPUP_BUTTONS = ["薬剤師（保険薬局）"] if POPUP_MODE else [] 
