...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://med.nipro.co.jp/society"
GAKKAI = "ニプロ株式会社（セミナー）"

SELECTOR_TITLE = "div.inner_col_01 div.society_article.auto_layout_system_24"
title_selector = "h2"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.inner_col_01 div.society_article.auto_layout_system_24"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "年"
month_unit = "月"
