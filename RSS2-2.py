...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://med.towayakuhin.co.jp/medical/"
GAKKAI = "東和薬品(医療機関)"

SELECTOR_TITLE = "dl.newsList.general dd"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "dl.newsList.general dt"
date_selector = ""
date_index = 0
year_unit = "/"
month_unit = "/"
...
POPUP_BUTTONS = ["薬剤師（薬局）"]  # 正確なボタン表記だけを指定
